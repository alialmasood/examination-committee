...
يُسمح بالاستلام على رأس الأمر في الحالات: `APPROVED` | `PARTIALLY_RECEIVED` | `RECEIVED` | `PARTIALLY_INVOICED`  
(حتى لا تُحجب سطور مفتوحة عندما يُفوتر سطر آخر في أمر متعدد السطور). السقف الفعلي يبقى على مستوى السطر: `open_receive`.
