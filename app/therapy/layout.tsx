      ...
      <div className={`${sidebarOpen ? 'block' : 'hidden'} lg:w-64 bg-red-950 shadow-sm border-r border-red-900 min-h-screen fixed top-0 right-0 z-50 flex flex-col`}>
        ...
        <nav className="pt-4 px-2">
          <div className="space-y-1">
            ...
            {/* Exam Schedule */}
            <Link
              href="/therapy/exam-schedule"
              className={`group flex items-center px-2 py-2 text-sm font-medium transition-all duration-200 ${
                pathname === '/therapy/exam-schedule' 
                  ? 'bg-red-800 text-white border-r-4 border-yellow-400 shadow-lg -mx-2 px-4' 
                  : 'text-red-100 hover:bg-red-900 hover:text-white hover:-mx-2 hover:px-4 rounded-md'
              }`}
            >
            ...
            {/* Students */}
            <Link
              href="/therapy/students"
              className={`group flex items-center px-2 py-2 text-sm font-medium transition-all duration-200 ${
                pathname === '/therapy/students' 
                  ? 'bg-red-800 text-white border-r-4 border-yellow-400 shadow-lg -mx-2 px-4' 
                  : 'text-red-100 hover:bg-red-900 hover:text-white hover:-mx-2 hover:px-4 rounded-md'
              }`}
            >
            ...
            {/* Master Sheet Report */}
            <Link
              href="/therapy/master-sheet"
              className={`group flex items-center px-2 py-2 text-sm font-medium transition-all duration-200 ${
                pathname === '/therapy/master-sheet' 
                  ? 'bg-red-800 text-white border-r-4 border-yellow-400 shadow-lg -mx-2 px-4' 
                  : 'text-red-100 hover:bg-red-900 hover:text-white hover:-mx-2 hover:px-4 rounded-md'
              }`}
            >
            ...
            {/* Sub Master Report */}
            <Link
              href="/therapy/sub-master"
              className={`group flex items-center px-2 py-2 text-sm font-medium transition-all duration-200 ${
                pathname === '/therapy/sub-master' 
                  ? 'bg-red-800 text-white border-r-4 border-yellow-400 shadow-lg -mx-2 px-4' 
                  : 'text-red-100 hover:bg-red-900 hover:text-white hover:-mx-2 hover:px-4 rounded-md'
              }`}
            >
            ...
            {/* Teaching Staff */}
            <Link
              href="/therapy/teaching"
              className={`group flex items-center px-2 py-2 text-sm font-medium transition-all duration-200 ${
                pathname === '/therapy/teaching' 
                  ? 'bg-red-800 text-white border-r-4 border-yellow-400 shadow-lg -mx-2 px-4' 
                  : 'text-red-100 hover:bg-red-900 hover:text-white hover:-mx-2 hover:px-4 rounded-md'
              }`}
            >
            ...
            {/* Results */}
            <Link
              href="/therapy/results"
              className={`group flex items-center px-2 py-2 text-sm font-medium transition-all duration-200 ${
                pathname === '/therapy/results' 
                  ? 'bg-red-800 text-white border-r-4 border-yellow-400 shadow-lg -mx-2 px-4' 
                  : 'text-red-100 hover:bg-red-900 hover:text-white hover:-mx-2 hover:px-4 rounded-md'
              }`}
            >
            ...
            {/* Reports */}
            <Link
              href="/therapy/reports"
              className={`group flex items-center px-2 py-2 text-sm font-medium transition-all duration-200 ${
                pathname === '/therapy/reports' 
                  ? 'bg-red-800 text-white border-r-4 border-yellow-400 shadow-lg -mx-2 px-4' 
                  : 'text-red-100 hover:bg-red-900 hover:text-white hover:-mx-2 hover:px-4 rounded-md'
              }`}
            >
            ...
            {/* Settings */}
            <Link
              href="/therapy/settings"
              className={`group flex items-center px-2 py-2 text-sm font-medium transition-all duration-200 ${
                pathname === '/therapy/settings' 
                  ? 'bg-red-800 text-white border-r-4 border-yellow-400 shadow-lg -mx-2 px-4' 
                  : 'text-red-100 hover:bg-red-900 hover:text-white hover:-mx-2 hover:px-4 rounded-md'
              }`}
            >
              ...
              <div className="flex items-center">
                ...
                <div className="mr-4">
                  <div className="flex items-center space-x-4 space-x-reverse">
                    <h1 className="text-2xl font-bold text-white">نظام اللجنة الامتحانية - قسم تقنيات العلاج الطبيعي</h1>
