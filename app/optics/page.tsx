...
export default function OpticsDashboard() {
  return (
    <div className="p-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              قسم تقنيات البصريات - كلية الشرق للعلوم التقنية التخصصية
            </p>
          </div>
        </div>
            ...
            <div className="p-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    <p className="font-medium text-gray-900">امتحان التشريح</p>
                    <p className="text-sm text-gray-500">المرحلة الأولى - الفصل الأول</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-medium text-blue-600">15/12/2024</p>
                    <p className="text-xs text-gray-500">09:00 ص</p>
                  </div>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    <p className="font-medium text-gray-900">امتحان الفيزيولوجيا</p>
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    <p className="font-medium text-gray-900">امتحان الكيمياء الحيوية</p>
                    <p className="text-sm text-gray-500">المرحلة الأولى - الفصل الأول</p>
                  </div>
                  <div className="text-right">
            ...
            <div className="p-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-blue-600">78.2</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-red-600">45.0</span>
                </div>
                <div className="flex items-center justify-between">
