...
export default function XraysLayout({
  children,
}: {
      ...
      <div className={`${sidebarOpen ? 'block' : 'hidden'} lg:w-64 bg-red-950 shadow-sm border-r border-red-900 min-h-screen fixed top-0 right-0 z-50 flex flex-col`}>
        ...
        <div className="flex items-center h-18 border border-white rounded-lg mx-1 my-2 px-4">
          ...
          <div className="text-white text-right text-sm font-bold leading-relaxed">
            ...
            <div className="whitespace-nowrap text-xs">قسم تقنيات الأشعة</div>
          </div>
        </div>
        ...
        <nav className="pt-4 px-2">
          <div className="space-y-1">
            ...
            {/* Exam Schedule */}
            <Link
              href="/xrays/exam-schedule"
              className={`group flex items-center px-2 py-2 text-sm font-medium transition-all duration-200 ${
                pathname === '/xrays/exam-schedule' 
                  ? 'bg-red-800 text-white border-r-4 border-yellow-400 shadow-lg -mx-2 px-4' 
                  : 'text-red-100 hover:bg-red-900 hover:text-white hover:-mx-2 hover:px-4 rounded-md'
              }`}
            >
            ...
            {/* Master Sheet Report */}
            <Link
              href="/xrays/master-sheet"
              className={`group flex items-center px-2 py-2 text-sm font-medium transition-all duration-200 ${
                pathname === '/xrays/master-sheet' 
                  ? 'bg-red-800 text-white border-r-4 border-yellow-400 shadow-lg -mx-2 px-4' 
                  : 'text-red-100 hover:bg-red-900 hover:text-white hover:-mx-2 hover:px-4 rounded-md'
              }`}
            >
            ...
            {/* Sub Master Report */}
            <Link
              href="/xrays/sub-master"
              className={`group flex items-center px-2 py-2 text-sm font-medium transition-all duration-200 ${
                pathname === '/xrays/sub-master' 
                  ? 'bg-red-800 text-white border-r-4 border-yellow-400 shadow-lg -mx-2 px-4' 
                  : 'text-red-100 hover:bg-red-900 hover:text-white hover:-mx-2 hover:px-4 rounded-md'
              }`}
            >
              ...
              <div className="flex items-center">
                ...
                <div className="mr-4">
                  <div className="flex items-center space-x-4 space-x-reverse">
                    <h1 className="text-2xl font-bold text-white">نظام اللجنة الامتحانية - قسم تقنيات الأشعة</h1>
