...
export default function XraysDashboard() {
  return (
    <div className="p-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              قسم تقنيات الأشعة - كلية الشرق للعلوم التقنية التخصصية
            </p>
          </div>
        </div>
            ...
            <div className="p-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    <p className="font-medium text-gray-900">امتحان الفيزياء الطبية</p>
                    <p className="text-sm text-gray-500">المرحلة الأولى - الفصل الأول</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-medium text-blue-600">18/12/2024</p>
                    <p className="text-xs text-gray-500">09:00 ص</p>
                  </div>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    <p className="font-medium text-gray-900">امتحان التشريح الإشعاعي</p>
                    <p className="text-sm text-gray-500">المرحلة الثانية - الفصل الأول</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-medium text-blue-600">22/12/2024</p>
                    <p className="text-xs text-gray-500">10:00 ص</p>
                  </div>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    <p className="font-medium text-gray-900">امتحان تقنيات التصوير</p>
                    <p className="text-sm text-gray-500">المرحلة الأولى - الفصل الأول</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-medium text-blue-600">25/12/2024</p>
            ...
            <div className="p-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-blue-600">81.5</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-gray-500">أعلى درجة</span>
                  <span className="text-sm font-bold text-purple-600">97.8</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-gray-500">أدنى درجة</span>
                  <span className="text-sm font-bold text-red-600">52.3</span>
                </div>
                <div className="flex items-center justify-between">
