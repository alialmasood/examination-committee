...
export default function MasterSheetPage() {
  ...
  const totalColsFirst = data.firstSemesterSubjects.length * 9; // 3 (مادة + وحدات + مدرس) + 6 (السعي + الدور الأول + المجموع + الدور الثاني + المجموع + الاستحقاق)
  const totalColsSecond = data.secondSemesterSubjects.length * 9;
            ...
            <thead className="bg-gray-50">
              ...
              <tr>
                ...
                {data.firstSemesterSubjects.map((subject) => (
                  <th key={subject.subject_id} colSpan={9} className="px-2 py-2 text-center text-xs font-medium text-gray-500 uppercase border border-gray-300 bg-blue-50">
                ...
                {data.secondSemesterSubjects.map((subject) => (
                  <th key={subject.subject_id} colSpan={9} className="px-2 py-2 text-center text-xs font-medium text-gray-500 uppercase border border-gray-300 bg-green-50">
                    {subject.material_name}
                  </th>
                ))}
              </tr>
              <tr>
                ...
                {data.firstSemesterSubjects.map((subject) => (
                  <React.Fragment key={subject.subject_id}>
                    <th className="px-1 py-2 text-center text-[10px] font-medium text-gray-500 uppercase border border-gray-300 bg-blue-50">المادة</th>
                    <th className="px-1 py-2 text-center text-[10px] font-medium text-gray-500 uppercase border border-gray-300 bg-blue-50">الوحدات</th>
                    <th className="px-1 py-2 text-center text-[10px] font-medium text-gray-500 uppercase border border-gray-300 bg-blue-50">المدرس</th>
                ...
                {data.secondSemesterSubjects.map((subject) => (
                  <React.Fragment key={subject.subject_id}>
                    <th className="px-1 py-2 text-center text-[10px] font-medium text-gray-500 uppercase border border-gray-300 bg-green-50">المادة</th>
                    <th className="px-1 py-2 text-center text-[10px] font-medium text-gray-500 uppercase border border-gray-300 bg-green-50">الوحدات</th>
                    <th className="px-1 py-2 text-center text-[10px] font-medium text-gray-500 uppercase border border-gray-300 bg-green-50">المدرس</th>
                ...
                return (
                  <tr key={student.id} className="hover:bg-gray-50">
                    ...
                    {data.firstSemesterSubjects.map((subject) => {
                      ...
                      return (
                        <React.Fragment key={subject.subject_id}>
                          <td className="px-1 py-2 text-center text-[10px] text-gray-700 border border-gray-300 bg-blue-50">{subject.material_name}</td>
                          <td className="px-1 py-2 text-center text-[10px] text-gray-700 border border-gray-300 bg-blue-50">{getSubjectUnits(subject)}</td>
                          <td className="px-1 py-2 text-center text-[10px] text-gray-700 border border-gray-300 bg-blue-50">{subject.instructor_name}</td>
                    ...
                    {data.secondSemesterSubjects.map((subject) => {
                      ...
                      return (
                        <React.Fragment key={subject.subject_id}>
                          <td className="px-1 py-2 text-center text-[10px] text-gray-700 border border-gray-300 bg-green-50">{subject.material_name}</td>
                          <td className="px-1 py-2 text-center text-[10px] text-gray-700 border border-gray-300 bg-green-50">{getSubjectUnits(subject)}</td>
                          <td className="px-1 py-2 text-center text-[10px] text-gray-700 border border-gray-300 bg-green-50">{subject.instructor_name}</td>
