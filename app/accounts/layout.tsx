...
import SidebarStatsCard from '../components/SidebarStatsCard';
...
export default function AccountsLayout({
  ...
  const getAcademicInfo = () => {
    ...
    return { academicYear, semester } as { academicYear: string; semester: string };
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className={`${sidebarOpen ? 'block' : 'hidden'} lg:w-64 bg-red-950 shadow-sm border-r border-red-900 min-h-screen fixed top-0 right-0 z-50 print:hidden`}>
        ...
        <nav className="pt-2 px-2">
          <div className="space-y-0.5">
            ...
            <Link
              ...
              className={`group flex items-center px-2 py-1.5 text-sm font-medium transition-all duration-200 ${
                pathname === '/accounts/promotion-approvals' ||
                pathname?.startsWith('/accounts/promotion-approvals/')
                  ? 'bg-red-800 text-white border-r-4 border-yellow-400 shadow-lg -mx-2 px-4'
                  : 'text-red-100 hover:bg-red-900 hover:text-white hover:-mx-2 hover:px-4 rounded-md'
              }`}
            >
        ...
        <SidebarStatsCard showHeader={false} className="mt-28" />
      </div>
              ...
              <div className="flex items-center">
                ...
                <div className="mr-4">
                  <div className="flex items-center space-x-4 space-x-reverse">
                    <h1 className="text-2xl font-bold text-white">نظام الحسابات</h1>
