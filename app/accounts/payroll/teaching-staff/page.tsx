        ...
        <table className="min-w-full border-collapse text-sm">
          <thead>
            <tr className="border-b border-gray-200 bg-red-950 text-white">
              ...
              <th className="px-3 py-2.5 text-right font-semibold whitespace-nowrap">الاسم بالعربية</th>
              ...
              <th className="px-3 py-2.5 text-right font-semibold whitespace-nowrap">رقم الهوية الجامعية</th>
              ...
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                <div>
                  <label className={labelClass}>
                    الاسم بالعربية <span className="text-red-700">*</span>
                  </label>
                  <input
                    className={inputClass}
                ...
                <div>
                  <label className={labelClass}>الاسم بالإنكليزية (اختياري)</label>
                  <input
                    className={inputClass}
                    dir="ltr"
