...
export default function LecturersPage() {
  ...
  const [terminateRow, setTerminateRow] = useState<LecturerRow | null>(null);
  const [terminateReason, setTerminateReason] = useState('');
  const [terminateError, setTerminateError] = useState('');

  const [deleteRow, setDeleteRow] = useState<LecturerRow | null>(null);
  ...
  return (
    <main dir="rtl" className="p-4 w-full">
      <div className="mb-2 flex flex-wrap items-center justify-between gap-3">
        <h1 className="text-xl font-bold text-gray-800">المحاضرين</h1>
        <button
          type="button"
          onClick={openCreate}
          ...
          >
            ...
            <form onSubmit={onSubmit} className="space-y-3 p-4">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <div>
                  <label className={labelClass}>جهة الانتساب</label>
                  <input
                    className={inputClass}
        ...
        >
          ...
          >
            <div className="border-b border-gray-200 bg-amber-800 px-4 py-3 text-white">
              <h2 className="text-base font-bold">إنهاء خدمة محاضر</h2>
            </div>
        ...
        >
          ...
          >
            <div className="border-b border-gray-200 bg-red-950 px-4 py-3 text-white">
              <h2 className="text-base font-bold">حذف محاضر</h2>
            </div>
            <div className="space-y-3 p-4">
              <p className="text-sm text-gray-700">
                هل أنت متأكد من حذف{' '}
