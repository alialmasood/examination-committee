...
export default function SystemsAdminPage() {
  ...
  const load = useCallback(async () => {
    ...
    setError('');
    try {
      const res = await fetch('/api/admin/systems', { credentials: 'include' });
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto" dir="rtl">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">إدارة الأنظمة وكلمات المرور</h1>
        <p className="text-sm text-gray-600 mt-1">
          عرض الأنظمة المسجّلة في المنصة وتغيير كلمة مرور مستخدمي كل نظام.
        </p>
      </div>
          ...
          {systems.map((system) => (
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-4 border-b border-gray-100 bg-slate-50">
                <div>
                  <h2 className="text-lg font-semibold text-gray-900">{system.name_ar}</h2>
                          ...
                          <tr key={u.id} className="border-b border-gray-50 last:border-0">
                            ...
                            <td className="py-3">
                              <button
                                ...
                                className="text-indigo-700 hover:text-indigo-900 font-medium underline-offset-2 hover:underline"
                              >
                                تغيير كلمة المرور
                              </button>
                            </td>
      ...
      {modalOpen && selectedUser && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" dir="rtl">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-5">
            <h3 className="text-lg font-semibold text-gray-900 mb-1">تغيير كلمة المرور</h3>
            ...
            <div className="flex justify-end gap-2 mt-2">
              ...
              <button
                type="button"
                className="bg-indigo-800 text-white rounded-lg px-4 py-2 text-sm disabled:opacity-50"
                disabled={saving}
