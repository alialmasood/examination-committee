...
export const STUDENT_RECEIVABLES_CAPABILITIES = {
  ...
  BILLING_VIEW: 'student_billing.view',
  BILLING_MANAGE: 'student_billing.manage',
  BILLING_ACTIVATE: 'student_billing.activate',
  ...
  CREDIT_NOTES_VIEW: 'student_credit_notes.view',
  CREDIT_NOTES_PREPARE: 'student_credit_notes.prepare',
  CREDIT_NOTES_APPROVE: 'student_credit_notes.approve',
  CREDIT_NOTES_POST: 'student_credit_notes.post',
  CREDIT_NOTES_VOID: 'student_credit_notes.void',
  REFUNDS_VIEW: 'student_refunds.view',
  REFUNDS_PREPARE: 'student_refunds.prepare',
  REFUNDS_APPROVE: 'student_refunds.approve',
  REFUNDS_POST: 'student_refunds.post',
  REFUNDS_VOID: 'student_refunds.void',
...
const CLERK_CAPS = new Set<string>([
  ...
  STUDENT_RECEIVABLES_CAPABILITIES.REFUNDS_VIEW,
  STUDENT_RECEIVABLES_CAPABILITIES.REFUNDS_PREPARE,
]);
...
const APPROVER_CAPS = new Set<string>([
  ...
  STUDENT_RECEIVABLES_CAPABILITIES.REFUNDS_VIEW,
  STUDENT_RECEIVABLES_CAPABILITIES.REFUNDS_PREPARE,
  STUDENT_RECEIVABLES_CAPABILITIES.REFUNDS_APPROVE,
]);
...
const ADMIN_CAPS = new Set<string>([
  ...
  STUDENT_RECEIVABLES_CAPABILITIES.CREDIT_NOTES_VOID,
  STUDENT_RECEIVABLES_CAPABILITIES.REFUNDS_APPROVE,
  STUDENT_RECEIVABLES_CAPABILITIES.REFUNDS_POST,
  STUDENT_RECEIVABLES_CAPABILITIES.REFUNDS_VOID,
