...
/**
 * تزامن متفائل: version إلزامي + updated_at إلزامي للمطابقة.
 */
export function assertCashBoxOptimisticConcurrency(params: {
  ...
  if (v !== params.currentVersion) {
    throw new AccountsHttpError(
      'تم تعديل الصندوق بواسطة مستخدم آخر، يرجى إعادة التحميل',
      409
    );
  }
  ...
  if (currentMs !== expectedMs) {
    throw new AccountsHttpError(
      'تم تعديل الصندوق بواسطة مستخدم آخر (updated_at)، يرجى إعادة التحميل',
      409
    );
  }
}
