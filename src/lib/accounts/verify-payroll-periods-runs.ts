...
const ACTIVE_RUN_STATUSES = ['DRAFT', 'CALCULATING', 'CALCULATED', 'UNDER_REVIEW', 'APPROVED'];
const OVERLAP_PERIOD_STATUSES = ['OPEN', 'PROCESSING', 'CLOSED'];
const PERIOD_STATUSES = ['OPEN', 'PROCESSING', 'CLOSED', 'CANCELLED'];
const RUN_STATUSES = ['DRAFT', 'CALCULATING', 'CALCULATED', 'UNDER_REVIEW', 'APPROVED', 'POSTED', 'CANCELLED'];
