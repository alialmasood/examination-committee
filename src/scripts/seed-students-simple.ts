...
async function main() {
  try {
    ...
    for (let i = 0; i < students.length; i++) {
      ...
      const insertQuery = `
        INSERT INTO student_affairs.students (
          ...
          secondary_total_score, admission_type, major, level, semester, academic_year,
    ...
    console.log('   - الأقسام: علوم الحاسوب، الهندسة');
    console.log('   - المراحل: البكالوريوس');
    console.log('   - الحالات: نشط');
